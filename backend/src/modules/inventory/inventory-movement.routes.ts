...
router.get('/movements', protect, withTenant, staffOrAdmin, async (req: any, res) => {
  try {
...
router.get('/movements/product/:productId', protect, withTenant, staffOrAdmin, async (req: any, res) => {
  try {
