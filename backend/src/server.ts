...
import filamentRoutes from './modules/filaments/filament.routes';
...
app.use(limiter);
app.use(express.json({ limit: '15mb' })); // 15mb: la importación de la planilla manda cientos de filas en un POST
